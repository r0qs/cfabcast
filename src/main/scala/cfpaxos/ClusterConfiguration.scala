...
case class SimpleClusterConfiguration(instance: Long, round: Round, quorumSize: Int, proposers: Set[ActorRef], acceptors: Set[ActorRef], learners: Set[ActorRef]) extends ClusterConfiguration
